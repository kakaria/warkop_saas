...
#         self.kasir_a = User.objects.create_user(
#             email="kasir@kemang.com", password="password123"
#         )
#         TenantMembership.objects.create(
#             tenant=self.tenant_a, user=self.kasir_a, role=TenantMembership.Role.CASHIER
#         )
...
#         self.order_a = Order.global_objects.create(
#             tenant=self.tenant_a, total_price=50000
#         )
#         self.order_b = Order.global_objects.create(
#             tenant=self.tenant_b, total_price=30000
#         )
...
#         response = self.client.get(self.url, HTTP_X_TENANT_ID=str(self.tenant_a.id))
...
#         self.assertEqual(
#             len(data), 1, "Gagal: Kasir Kemang harusnya cuma lihat 1 pesanan!"
#         )
...
#             data[0]["id"],
#             self.order_a.id,
#             "Gagal: Data yang muncul bukan punya Kemang!",
#         )
...
#         self.assertNotIn(
#             self.order_b.id, order_ids_in_response, "BENCANA: Data Warkop Depok Bocor!"
#         )
